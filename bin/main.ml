let () = 
    ...
    Printf.printf "Sample part1: %d\n" (Day10.part1 sample_lines);
    Printf.printf "Solution part 1: %d\n" (Day10.part1 input_lines);
    Printf.printf "Sample part2: %f\n" (Day10.part2 sample_lines);
    Printf.printf "Solution part 2: %f\n" (Day10.part2 input_lines);
